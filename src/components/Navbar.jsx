...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to='/'><img src={assets.logo} className='w-40 md:w-48' alt='logo'/></Link>
      ...
      <div className='flex items-center gap-6'>
        ...
        <Link to='/cart' className='relative'>
          ...
          <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-blue-600 text-white rounded-full aspect-square text-[8px]'>{getCartCount()}</p>
        </Link>
        <img onClick={() => setVisible(true)} src={assets.menu_icon} className='w-5 sm:hidden cursor-pointer' alt='menu_icon'/>
      </div>
